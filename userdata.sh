...
REGION="us-east-1" # use one of us-east-1, us-west-1, eu-west-1
CHEF_SERVER_NAME="HR-Chef-Test" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="hr-chef-test-b16x1rlwpyyprmpo.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
